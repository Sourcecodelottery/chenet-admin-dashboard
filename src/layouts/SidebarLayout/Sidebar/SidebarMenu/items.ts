...
const menuItems: MenuItems[] = [
  ...
  },
  {
    ...
    items: [
      {
        name: 'Broker Homepage',
        icon: EmojiEventsTwoToneIcon,
        link: routes.ADMIN.BROKER.ROUTE
      },
      {
        name: 'Driver Homepage',
        icon: SettingsTwoToneIcon,
        link: routes.ADMIN.DRIVER.ROUTE
      },
      {
        name: 'Combination User Homepage',
        icon: TrafficTwoToneIcon,
        link: routes.ADMIN.COMBINATION_USER.ROUTE
      },
      {
        name: 'Company Homepage',
        icon: FilterVintageTwoToneIcon,
        link: routes.ADMIN.COMPANY.ROUTE
      },
      {
        name: 'News Homepage',
        icon: MmsTwoToneIcon,
        link: routes.ADMIN.NEWS.ROUTE
      },
      {
      ...
      },
      {
        name: 'Settings',
        icon: BrightnessLowTwoToneIcon,
        link: routes.ADMIN.SETTINGS.ROUTE
      },
    ]
  },
  {
